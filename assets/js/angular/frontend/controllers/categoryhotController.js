...
angular.module("kp_clothes").controller('categoryhotController',['$scope','$rootScope','$state','$http','$stateParams','$log',function ($scope,$rootScope,$state,$http,$stateParams,$log) {
    $log.info("Category Hot Controller");
   ...
   // $log.debug(Products.test);
	...
	$scope.get_videos = function(){
		$http.get($rootScope.base_url+'home/get_videos/'+$stateParams.slug+'/hot')
