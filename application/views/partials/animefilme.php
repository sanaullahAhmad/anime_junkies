        ...
        <div class="subcategory video-items without-text top-space item">
            ...
            <div class="row">
              <div class="col-sm-6 col-md-3 col-xs-12">
                <p class="title top-space5"><i class="text-danger icon-fontello-video"></i> MEINE  <strong>VIDEOS</strong></p>
              </div>
            ...
            <div class="row top-space ">
              ...
              <?php 
			   $rows = $this->Generic_model->select('videos', "", "user_id='".$this->session->userdata('id')."'");
				if(!empty($rows) && sizeof($rows)>0)
				{
					foreach($rows as $row)
					{
						...
						<div class="col-sm-3 col-md-2 zoom-it bottom-space">
                            <a class="video-play hover-text" href="video-detail.html">
                              <p class="img">
