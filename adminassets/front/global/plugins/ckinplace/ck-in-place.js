...
$.fn.ckeip = function (options, callback) {
    ...
    return this.each(function () {
        ...
        $(this).before("<div id='ckeip_" + u_id + "'  style='display:block;'><textarea id ='ckeip_e_" + u_id + "' cols='" + settings.e_width + "' rows='" + settings.e_height + "'  >" + eip_html + "</textarea><input type='button' value='Save' id='save_ckeip_" + u_id + "' /> <input type='button' value='Cancel' id='cancel_ckeip_" + u_id + "' /></div>");
